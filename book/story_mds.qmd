...
Вот как это выглядит на настоящих данных: 34 крупнейших города Европы, на входе только
таблица расстояний между ними. Двигайте число городов и переключайте метод — карта
собирается сама, а разрыв между градиентным и безградиентным методом растёт вместе
с размерностью.
...
- [**PCA и eigenfaces**](story_pca.html) — классический MDS это тот же PCA, только из расстояний
